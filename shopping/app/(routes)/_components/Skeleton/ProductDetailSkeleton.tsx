      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-8 container">
        ...
        <div className="col-span-1">
          <div className="flex flex-col gap-3">
            <Skeleton className="h-10 w-80 skecolor" />
            <Skeleton className="h-6 w-40 skecolor" />
            <Skeleton className="h-24 w-full skecolor" />
            <div className="flex gap-3">
              <Skeleton className="h-6 w-20 skecolor" />
              <Skeleton className="h-6 w-20 skecolor" />
            </div>
            <div className="flex gap-3">
              <Skeleton className="h-8 w-36 skecolor" />
              <Skeleton className="h-8 w-36 skecolor" />
            </div>
            ...
            <div className="flex gap-3 mt-8">
              <Skeleton className="h-12 w-28 skecolor" />
            </div>
          </div>
        </div>
      </div>
